...
const Achievements = () => {
    ...
    return (
        <Fragment>
         ...
         <Grid item xs={12} sm={12} md={6} lg={6} xl={6} style={{paddingTop:'100px',}}>
         ...
         <Hidden smDown>
         <Grid item xs={false} sm={false} md={6} lg={6} xl={6} style={{paddingTop:'100px',}}>
        <img src={Winner} alt='event_img' height='60%' width='100%' />
         </Grid>
         </Hidden>
         </Grid>
